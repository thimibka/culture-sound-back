...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<minitest>.freeze, ["~> 5.21"])
    s.add_development_dependency(%q<minitest-junit>.freeze, ["~> 1.0"])
    s.add_development_dependency(%q<rdoc>.freeze, ["~> 6.6"])
    ...
    s.add_dependency(%q<minitest>.freeze, ["~> 5.21"])
    s.add_dependency(%q<minitest-junit>.freeze, ["~> 1.0"])
    s.add_dependency(%q<rdoc>.freeze, ["~> 6.6"])
